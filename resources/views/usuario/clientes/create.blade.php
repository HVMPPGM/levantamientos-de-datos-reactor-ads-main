...
<head>
    ...
    <title>Nuevo Cliente - Sistema de Levantamientos</title>
...
<body>
                ...
                <form id="clienteForm" novalidate>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="telefono" maxlength="25" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="no_externo">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">No. Interior</label>
                            <input type="number" class="form-control" name="no_interno">
                        </div>
                    </div>
                    ...
                    <div class="alert-info-custom">
                        ...
                        Puedes seleccionar hasta 9 artículos adicionales. Total máximo: 10 artículos.
                    </div>
                    <input type="hidden" id="articulo_principal" name="articulo_principal">
                    <div class="articulos-grid">
                        @foreach($articulos as $articulo)
                        <div class="articulo-item" data-articulo-id="{{ $articulo->Id_Articulos }}">
                            ...
                            <div class="articulo-detalles">
                                ...
                                @if($articulo->Descripcion)
                                    <br><small>{{ Str::limit($articulo->Descripcion, 50) }}</small>
                                @endif
                            </div>
                        </div>
                        @endforeach
    ...
    <script>
        ...
        function manejarErrorAjax(xhr) {
            ...
            if (xhr.status === 422) {
                ...
                if (resp.campos_duplicados && resp.campos_duplicados.length > 0) {
                    // Marcar campos duplicados en rojo
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: xhr.responseJSON?.message || 'Ocurrió un error al guardar el cliente.',
                    confirmButtonColor: '#dc3545'
                });
            }
        }
        ...
        $('#clienteForm').submit(function (e) {
            ...
            $.ajax({
                url: '{{ route("usuario.clientes.store") }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
