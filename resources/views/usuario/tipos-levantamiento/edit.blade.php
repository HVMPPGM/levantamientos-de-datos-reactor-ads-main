...
<head>
    ...
    <title>Editar Tipo de Levantamiento - Sistema de Levantamientos</title>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0 text-gray-800">
                        <i class="fas fa-edit me-2"></i>Editar Tipo de Levantamiento
                    </h1>
                    <p class="text-muted mb-0">Actualiza la información del tipo</p>
                </div>
                            ...
                            <form id="formTipo">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="descripcion" 
                                              rows="3"
                                              placeholder="Breve descripción del tipo de levantamiento">{{ $tipo->Descripcion }}</textarea>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="icon-box bg-primary bg-opacity-10 text-primary rounded-3 p-3 me-3">
                                                    <i id="preview-icon" class="fas {{ $tipo->Icono }} fa-2x"></i>
                                                </div>
                                                <div>
                                                    <h5 id="preview-nombre" class="mb-1">{{ $tipo->Nombre }}</h5>
                                                    <p id="preview-descripcion" class="text-muted mb-0 small">
                                                        {{ $tipo->Descripcion ?? 'Descripción del tipo' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch('{{ route("usuario.tipos-levantamiento.update", $tipo->Id_Tipo_Levantamiento) }}', {
                    method: 'POST',
                    headers: {
                    ...
                    if (data.success) {
                        Swal.fire({
                            ...
                            window.location.href = 
                                '{{ route("usuario.tipos-levantamiento.show", $tipo->Id_Tipo_Levantamiento) }}';
                        });
                    } else {
